test_that("counting with note-based citation works with cross references", {
  test_file <- test_file_parts(here::here("tests/testthat/test-notes-citation-crossref.qmd"))
