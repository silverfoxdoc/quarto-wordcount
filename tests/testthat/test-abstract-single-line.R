test_that("counting single-line abstract works", {
  test_file <- test_file_parts(here::here("tests/testthat/test-abstract-single-line.qmd"))
  ...
  expect_equal(counts$wordcount_abstract_words, 8)
  ...
  expect_equal(counts$wordcount_total_words, 13)
})
